...
Produces ``dist/NishizumiTranslations/``. The Windows installer in
``installer/jp2subs.iss`` packages that folder.
"""
...
from jp2subs import __version__  # noqa: E402
from jp2subs import branding  # noqa: E402

BUNDLE_NAME = "NishizumiTranslations"
...
EXCLUDED_MODULES = ("tkinter", "matplotlib", "PIL", "pytest", "setuptools")
...
def build_command(args: argparse.Namespace, build_dir: Path) -> list[str]:
    ...
    command.extend(
        [
            "--collect-submodules=jp2subs",
            "--hidden-import=jp2subs.gui.main",
            "--hidden-import=jp2subs.runtime.manager",
    ...
    command.append(str(SRC_DIR / "jp2subs" / "gui" / "__main__.py"))
    return command
